...
class DigestAuth:
    ...
    def response(self):
        if self.params.has_key("qop"):
            ...
            #                              ":" H(A2)
            #                      ) <">
            print self.H(self.A1())
            print self.H(self.A2())
            print self.params["nonce"] + ":" + self.params["nc"]  + ":" + self.params["cnonce"]  + ":" + self.params["qop"]   + ":" + self.H(self.A2())
